...
1. Cloner le dépôt
     ...
     git clone https://github.com/BG47510/dev.git cd votre-repo chmod +x filter_epg.sh
     ```
...
TF1.fr France2.fr M6.fr 

`urls.txt`**: Listez les URLs de vos sources XMLTV.

Plaintext

https://exemple.com/epg_complet.xml https://autre-source.org/guide.xml.gz 
...
Le script utilise XPath via xmlstarlet pour effectuer les opérations suivantes en une seule passe par source :
    ...
    - Limitation aux programmes des 3 prochains jours (peut-être modifiée).
